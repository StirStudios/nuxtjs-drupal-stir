...
const navigationUi = {
  root: `${adminTabsFontClass} sticky top-0 z-60 h-[3.3rem] w-full border-b border-zinc-200 bg-zinc-100 px-4 pt-4 pb-3 text-zinc-800 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-100`,
  list: 'isolate',
  item: 'relative',
